...
/*     public IEnumerator FOVKickOut()
    ...
    public class FPAIO_Editor : Editor{
        ...
        public override void OnInspectorGUI(){
            ...
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            t.Volume = EditorGUILayout.Slider(new GUIContent("Volume","Volume to play audioClip at."),t.Volume,0,10);
            EditorGUILayout.Space();
            ...
            if(t.fsmode == FirstPersonAIO.FSMode.Static){
                ...
                EditorGUILayout.EndFoldoutHeaderGroup();
                t.jumpSound = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("Jump Clip","An audioClip clip that will play when jumping."),t.jumpSound,typeof(AudioClip),false);
                t.landSound = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("Land Clip","An audioClip clip that will play when landing."),t.landSound,typeof(AudioClip),false);
